...
if (!(empty($_POST['email'])) === TRUE ) {
	...
	// On récupère directement tous les événements parents pour le moment => ensuite traités en fonction des users
	$query = "SELECT * FROM groups
                WHERE idgroup IN (SELECT DISTINCT idfather FROM grouprelations)
                AND conf = 1";
